"""v166: add the symmetric 850-level ECS pressure d14 push on top of v164.

v164 proved level 925 still transfers at lambda 0.80, while v165 showed station
bias offsets are not additive after the v102 station model. This clean follow-up
keeps v164 as the base and raises only level 850 from lambda 0.65 to 0.80,
leaving level 925 at v164's setting and avoiding all station rows.
"""
...
OUT_DIR = LOGS_DIR / "v166_pressure_d14_ecs_850_push80"

REGION = "east_china_sea"
TARGET_HORIZON = 14
UPGRADE_LEVELS = ["850"]
LEVEL_LAMBDAS = {"850": 0.80}
Q_COLS = ["q05", "q50", "q95"]
